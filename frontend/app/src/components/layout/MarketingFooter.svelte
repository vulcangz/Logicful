<footer class="bg-white">
    <div class="max-w-screen-xl mx-auto py-12 px-4 overflow-hidden space-y-8 sm:px-6 lg:px-8">
        <nav class="-mx-5 -my-2 flex flex-wrap justify-center">
            ...
            <div class="px-5 py-2">
                <a href="/form/builder?formId=demo" class="text-base leading-6 text-gray-500 hover:text-gray-900">
                    Try Demo
                </a>
            </div>
            <div class="px-5 py-2">
                <a href="/account/login" class="text-base leading-6 text-gray-500 hover:text-gray-900">
                    Sign In / Up
                </a>
            </div>
        </nav>
        ...
        <p class="mt-8 text-center text-base leading-6 text-gray-400">
            &copy; 2020 Logicful, Inc. All rights reserved.
        </p>
    </div>
</footer>
