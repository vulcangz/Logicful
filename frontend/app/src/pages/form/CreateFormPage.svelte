    ...
    <div class="relative max-w-7xl mx-auto">
      <div class="text-center">
        ...
        <p
          ...
          Create and share your custom form to collect data quickly and
          efficiently.
        </p>
      </div>
      <div
        class="mt-12 grid gap-5 max-w-lg mx-auto lg:grid-cols-2 lg:max-w-3xl">
        <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
          <div class="flex-shrink-0">
            <svg
              class="ml-3 mt-1"
              id="e8345542-4160-463b-841e-d6381701a249"
              data-name="Layer 1"
              xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink"
              width="95%"
              height="100%"
              viewBox="0 0 1014.92 616.5"><defs>
                <linearGradient
                  id="b96c1e95-21f7-460f-8fe8-281b03b6a731"
                  x1="223"
                  y1="366.33"
                  x2="223"
                ...
                <linearGradient
                  id="fdf2261c-aea2-449f-acb5-ed46fbfe76ac"
                  x1="315"
                  y1="481.74"
                  x2="315"
                  y2="115.42"
                  gradientTransform="matrix(-1, 0, 0, 1, 1106.92, -115.42)"
                  xlink:href="#b96c1e95-21f7-460f-8fe8-281b03b6a731" />
                <linearGradient
                  id="bdb7606e-5185-43e5-b133-41bac9927d37"
                  x1="508"
                  y1="616.5"
                  x2="508"
                  y2="159.83"
              ...
              <g opacity="0.5">
                <rect
                  width="446"
                  height="366.33"
                  fill="url(#b96c1e95-21f7-460f-8fe8-281b03b6a731)" />
              </g>
              <rect
                x="5.2"
                y="6.93"
              ...
              <g opacity="0.5">
                <rect
                  ...
                  width="446"
                  height="366.33"
                  fill="url(#fdf2261c-aea2-449f-acb5-ed46fbfe76ac)" />
              </g>
              <rect
                x="666.98"
                y="122.35"
                width="434.74"
                height="353.34"
                transform="translate(1676.71 482.61) rotate(-180)"
                fill="#f2f2f2" />
              <rect
                x="666.98"
                y="122.35"
                width="434.74"
                height="78.81"
                transform="translate(1676.71 208.08) rotate(-180)"
                fill="#6c63ff" />
              <rect
                x="666.98"
                y="122.35"
              ...
              <rect
                ...
                width="365.46"
                height="45.9"
                transform="translate(1676.71 389.95) rotate(-180)"
                fill="#e0e0e0" />
              <rect
                x="800.35"
                y="310.27"
                width="266.73"
                height="15.59"
                transform="translate(1775.43 520.72) rotate(-180)"
                fill="#e0e0e0" />
              <rect
                x="893.88"
                y="337.12"
                width="173.2"
                height="15.59"
                transform="translate(1868.96 574.41) rotate(-180)"
                fill="#e0e0e0" />
              <rect
                x="838.45"
                y="363.97"
                width="228.63"
                height="15.59"
                transform="translate(1813.54 628.1) rotate(-180)"
                fill="#e0e0e0" />
              <rect
                x="800.35"
                y="390.81"
                width="266.73"
                height="15.59"
                transform="translate(1775.43 681.79) rotate(-180)"
                fill="#e0e0e0" />
              <rect
                x="977.88"
                y="417.66"
                width="89.2"
                height="15.59"
                transform="translate(1952.97 735.49) rotate(-180)"
                fill="#e0e0e0" />
              <g opacity="0.5">
                <rect
                  x="230"
                  ...
                  width="556"
                  height="456.68"
                  fill="url(#bdb7606e-5185-43e5-b133-41bac9927d37)" />
              </g>
              <rect
                x="236.48"
                y="168.46"
            ...
            <div class="flex-1">
              <a href="#" class="block">
                ...
                <p class="mt-3 text-base leading-6 text-gray-500">
                  Create and customize your form from scratch with no prior
                  template.
                </p>
              </a>
            </div>
            <div class="mt-6 flex items-center">
              <Button type="primary" width="full" onClick={createNewForm}>
                Create
              </Button>
            </div>
          </div>
        ...
        <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
          <div class="flex-shrink-0">
            <svg
              ...
              width="95%"
              height="100%"
              viewBox="0 0 1140.56 787.27"><defs>
                <linearGradient
              ...
              <rect
                ...
                fill="#30374e" />
              <circle cx="672.39" cy="560.74" r="13.57" fill="#6c63ff" />
              <circle cx="672.39" cy="560.74" r="13.57" opacity="0.1" />
              <circle cx="673.15" cy="559.02" r="13.57" fill="#6c63ff" />
              <path
          ...
          <div class="flex-1 bg-white p-6 flex flex-col justify-between">
            <div class="flex-1">
              <a href="#" class="block">
                ...
                <p class="mt-3 text-base leading-6 text-gray-500">
                  Use one of our high-quality prebuilt templates to create your
                  form quickly.
                </p>
              </a>
            </div>
            <div class="mt-6 flex items-center">
              <Button type="primary" disabled={true} width="full">
                Create
              </Button>
            </div>
          </div>
